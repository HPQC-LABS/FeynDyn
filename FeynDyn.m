...
%% Bug reports, suggestions, and requests for extensions are more than encouraged: nike@hpqc.org (if it bounces, you can try nik.dattani@gmail.com or ndattani@uwaterloo.ca)
