%1) Variational polaron quantum master equation
...
dy = zeros (4,1);
dy(1)=-((Omega/(2*tau*sqrt(pi)))*exp(-(t./tau)^2))*y(3);    %Quantum evolution of rho_11 
dy(2)=-K*y(2);                                              %Quantum evolution of Re(rho_10)  
dy(3)=((Omega/(2*tau*sqrt(pi)))*exp(-(t./tau)^2))*(1/2)*(1-2*y(1))+K*y(3);   %Quantum evolution of Im(rho_10)
dy(4)=0
end
...
%Visualization of the elements of the density matrix
